...
/**
 * {@code WindowedAddMutator} is windowed {@code Mutator} that reports the
 * smallest of all values provided to it over a given time interval.
 * <p>
...
public final class WindowedMinMutator extends AbstractWindowedMutator {
    /**
     * The initial value of an {@code WindowedMinMutator} -
     * {@code Long.MAX_VALUE}.
     */
    public static final long INITIAL_VALUE = Long.MAX_VALUE;

    /**
     * Creates an instance of {@code WindowedMinMutator} using the given

...
public class JmxExporterTest {
    ...
    public void simple()
    throws Exception {
        ApplicationContext context = loadContext("jmx-exporter.xml",
                JmxExporterTest.class);

        JmxExporterBean bean = context.getBean(JmxExporterBean.class);
        assertNotNull(bean);
        assertTrue(bean.getAutoPublish());
